...
<div class="page" style="text-align: center;">
	...
	<p style="font-size: 16px; line-height: 28px; text-align: left;">Para que suas lentes fiquem sempre finas, elas são produzidas em resina orgânica de alto índice de refração 1.56 nas prescrições de miopia até -4 ou hipermetropia até +2, com astigmatismo até -2. Fora desses parâmetros, precisamos utilizar lentes mais caras, cobrando uma adicional de R$60 por óculos. Para entender melhor, entre no nosso FAQ ou fale conosco, que ficaremos felizes em te ajudar!</p>
